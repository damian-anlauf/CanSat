...
public class Listener extends Thread {
	...
	private String time, temp, pressure, altitude, pitch, roll, yaw, gpsTime, latitude, longtitude, gpsAltitude;
	...
	private static final int GPSALTITUDE = 11;
...
//				System.out.println(dataString);
				...
				dataString = packetNo+","+time+","+temp+","+pressure+","+altitude+","+pitch+","+roll+","+yaw+","+gpsTime+","+latitude+","+longtitude+","+gpsAltitude+","+status;
//				System.out.println(dataString);
